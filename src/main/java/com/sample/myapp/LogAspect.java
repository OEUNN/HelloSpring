...
public class LogAspect {
		...
		public void afterLog(JoinPoint joinPoint) {
			...
			System.out.println("[Log: After] 메서드 이름:"+signatrue.getName());
		}
		...
		public Object afterReturningLog(JoinPoint joinPoint, String message) {
			Signature signatrue = joinPoint.getSignature();
			System.out.println("[Log: AfterReturning] 메서드 이름:"+signatrue.getName());
		...
		public void afterThrowingLog(JoinPoint joinPoint, Exception exception) {
			Signature signatrue = joinPoint.getSignature();
			System.out.println("[Log: AfterThrowing] 메서드 이름:"+signatrue.getName());
